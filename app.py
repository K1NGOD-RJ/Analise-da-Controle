...
# --- 2. Pareto Analysis (80/20) por Líder ---
info_tooltip(
...
info_tooltip(
    "### 🎯 3. Pareto por Família",
    "Mesma lógica do Pareto por líder, mas aplicado às famílias de produtos. "
    "Ajuda a focar esforços nas famílias que mais contribuem para a produção."
)
if not df_filtrado.empty:
...
# --- 5. Anomaly Detection ---
info_tooltip(
    "### 🔍 5. Detecção de Anomalias (Z-Score > 3)",
...
# --- 6. Interactive Drill-Down Table ---
info_tooltip(
    "### 🔎 6. Tabela Interativa com Filtros",
...
# --- 8. Digital Twin: Projeção por Mês (com SDOR) ---
info_tooltip(
...
if log is not None and not df_filtrado.empty and len(log) > 0:
    # Usar média móvel do SDOR (últimos 3 meses)
